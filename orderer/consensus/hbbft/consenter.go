...
import (
	...
	etcdtohbbft "github.com/hyperledger/fabric/protos/orderer/etcdraft"
...
func (c *Consenter) ReceiverByChain(channelID string) MessageReceiver {
	...
	c.Logger.Warningf("Chain %s is of type %v and not hbbft.Chain", channelID, reflect.TypeOf(cs.Chain))
	return nil
}
